...
public class Student {
  ...
  public List<Grade> getGrades(){
    ...
    for (TeachingUnitResult unit_results : results)
        grades.add(unit_results.getGrade());
    return grades;
  }
  ...
  public void printResults(){
    ...
    for (TeachingUnitResult unit_results : results)
        System.out.println(unit_results.toString());
      System.out.println("Note moyenne : " + getAverageGrade().toString());
    return;
  }
